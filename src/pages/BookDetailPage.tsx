...
export function BookDetailPage() {
  ...
  const reviewMutation = useMutation({
    mutationFn: (data: { rating: number, reviewText: string }) => {
       return booksApi.submitReview(Number(id), data)
    },
    onSuccess: () => {
